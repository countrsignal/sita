#!/bin/bash
#SBATCH --job-name=SITA_pretrain_atflow_adp
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
#SBATCH --output=/net/pulsar/home/koes/dap181/labspace/sita/scripts/logs/sita-pretrain-atflow-adp-600epochs-0lnb.out
