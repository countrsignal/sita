#!/bin/bash
#SBATCH --job-name=AITA_finetune_ebm
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
#SBATCH --output=/net/pulsar/home/koes/dap181/labspace/aita/scripts/logs/aita-finetune-ebm-atp.out
...
python "$PRETRAIN_SCRIPT" experiment=finetune_ebm_atp trainer.max_epochs=400 loader.batch_size=512
